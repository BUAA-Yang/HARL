...
def main():
    ...
    parser.add_argument(
        "--exp_name", type=str, default="第一阶段", help="Experiment name."
    )
    parser.add_argument(
        "--load_config",
        type=str,
    ...
    algo_args['train']['model_dir'] = f"results\pettingzoo_mpe\simple_v2-continuous\happo\第一阶段\seed-00001-2025-03-18-11-21-36\models"
